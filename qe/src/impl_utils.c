...
QE_STATIC_API_IMPL(int) qe_vsnprintf(char* out, size_t cap, const char* fmt, va_list ap)
{
    size_t len = 0u;
...
QE_STATIC_API_IMPL(int) qe_snprintf(char* out, size_t cap, const char* fmt, ...)
{
    int result;
    va_list ap;
